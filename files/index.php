...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/lab1.jpg" alt="Chania" style="width: 1000px; max-height: 460px;">
        </div>

        <div class="item">
            <img src="assets/img/lab2.jpg" alt="Chania" style="width: 1000px; max-height: 460px;">
        </div>

        <div class="item">
            <img src="assets/img/lab3.jpg" alt="Flower" style="width: 1000px; max-height: 460px;">
        </div>

        <div class="item">
            <img src="assets/img/lab4.jpg" alt="Flower" style="width: 1000px; max-height: 460px;">
        </div>
    </div>
</div>
